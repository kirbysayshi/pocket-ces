...
Pocket.prototype.tick = function(dt) {
  ...
  Object.keys(this.entityIdsToDestroy).forEach(function(id) {
    self.immediatelyDestroyEntity(id);
...
Pocket.prototype.entity = function(componentsValues) {
  ...
  if (componentsValues.id && this.entities[componentsValues.id]) {
...
Pocket.prototype.destroyEntity = function(id) {
  this.entityIdsToDestroy[id] = true;
}

Pocket.prototype.immediatelyDestroyEntity = function(id) {
  var self = this;
